...
// export const TrophyIcon: React.FC<IconProps> = ({ className }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
//     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M19 3v4M6 4h12a1 1 0 001-1V3a1 1 0 00-1-1H6a1 1 0 00-1 1v1a1 1 0 001 1zm0 0v6a5 5 0 005 5h2a5 5 0 005-5V4M8 14v3a2 2 0 002 2h4a2 2 0 002-2v-3M12 14v5m-4 0h8" />
//   </svg>
// );
...
export const DoorExitIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1M15 12h.01" />
  </svg>
);
